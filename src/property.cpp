...
map
{
    ...
    , ENTRY( "water"  , "density"                        , massic enthalpy , massic_entropy  , IAPWS_R7         , r7::density_hs                                , density              )
    , ENTRY( "water"  , "density"                        , massic enthalpy , pressure        , IAPWS_R7         , r7::density_hp                                , density              )
    , ENTRY( "water"  , "density"                        , massic entropy  , massic_enthalpy , IAPWS_R7         , r7::density_sh                                , density              )
    ...
    , ENTRY( "water"  , "massic enthalpy"                , massic_entropy  , pressure        , IAPWS_R7         , r7::massic_enthalpy_sp                        , massic_enthalpy      )
    , ENTRY( "water"  , "massic enthalpy"                , pressure        , massic_entropy  , IAPWS_R7         , r7::massic_enthalpy_ps                        , massic_enthalpy      )
    ...
    , ENTRY( "water"  , "massic entropy"                 , massic_enthalpy , pressure        , IAPWS_R7         , r7::massic_entropy_hp                         , massic_entropy       )
    , ENTRY( "water"  , "massic entropy"                 , pressure        , massic_enthalpy , IAPWS_R7         , r7::massic_entropy_ph                         , massic_entropy       )
    ...
    , ENTRY( "water"  , "massic internal energy"         , massic_enthalpy , massic_entropy  , IAPWS_R7         , r7::massic_internal_energy_hs                 , massic_energy        )
    , ENTRY( "water"  , "massic internal energy"         , massic_enthalpy , pressure        , IAPWS_R7         , r7::massic_internal_energy_hp                 , massic_energy        )
    , ENTRY( "water"  , "massic internal energy"         , massic_entropy  , massic_enthalpy , IAPWS_R7         , r7::massic_internal_energy_sh                 , massic_energy        )
    , ENTRY( "water"  , "massic internal energy"         , massic_entropy  , pressure        , IAPWS_R7         , r7::massic_internal_energy_sp                 , massic_energy        )
    , ENTRY( "water"  , "massic internal energy"         , pressure        , massic_enthalpy , IAPWS_R7         , r7::massic_internal_energy_ph                 , massic_energy        )
    , ENTRY( "water"  , "massic internal energy"         , pressure        , massic_entropy  , IAPWS_R7         , r7::massic_internal_energy_ps                 , massic_energy        )
    ...
    , ENTRY( "water"  , "massic isobaric heat capacity"  , massic_enthalpy , massic_entropy  , IAPWS_R7         , r7::massic_isobaric_heat_capacity_hs          , massic_heat_capacity )
    , ENTRY( "water"  , "massic isobaric heat capacity"  , massic_enthalpy , pressure        , IAPWS_R7         , r7::massic_isobaric_heat_capacity_hp          , massic_heat_capacity )
    , ENTRY( "water"  , "massic isobaric heat capacity"  , massic_entropy  , massic_enthalpy , IAPWS_R7         , r7::massic_isobaric_heat_capacity_sh          , massic_heat_capacity )
    , ENTRY( "water"  , "massic isobaric heat capacity"  , massic_entropy  , pressure        , IAPWS_R7         , r7::massic_isobaric_heat_capacity_sp          , massic_heat_capacity )
    , ENTRY( "water"  , "massic isobaric heat capacity"  , pressure        , massic_enthalpy , IAPWS_R7         , r7::massic_isobaric_heat_capacity_ph          , massic_heat_capacity )
    , ENTRY( "water"  , "massic isobaric heat capacity"  , pressure        , massic_entropy  , IAPWS_R7         , r7::massic_isobaric_heat_capacity_ps          , massic_heat_capacity )
    ...
    , ENTRY( "water"  , "massic volume"                  , massic_enthalpy , massic_entropy  , IAPWS_R7         , r7::massic_volume_hs                          , massic_volume        )
    , ENTRY( "water"  , "massic volume"                  , massic_enthalpy , pressure        , IAPWS_R7         , r7::massic_volume_hp                          , massic_volume        )
    , ENTRY( "water"  , "massic volume"                  , massic_entropy  , massic_enthalpy , IAPWS_R7         , r7::massic_volume_sh                          , massic_volume        )
    , ENTRY( "water"  , "massic volume"                  , massic_entropy  , pressure        , IAPWS_R7         , r7::massic_volume_sp                          , massic_volume        )
    , ENTRY( "water"  , "massic volume"                  , pressure        , massic_enthalpy , IAPWS_R7         , r7::massic_volume_ph                          , massic_volume        )
    , ENTRY( "water"  , "massic volume"                  , pressure        , massic_entropy  , IAPWS_R7         , r7::massic_volume_ps                          , massic_volume        )
    ...
    , ENTRY( "water"  , "pressure"                       , massic enthalpy , massic_entropy  , IAPWS_R7         , r7::pressure_hs                               , pressure             )
    , ENTRY( "water"  , "pressure"                       , massic entropy  , massic_enthalpy , IAPWS_R7         , r7::pressure_sh                               , pressure             )
    , ENTRY( "water"  , "speed of sound"                 , massic_enthalpy , massic_entropy  , IAPWS_R7         , r7::speed_of_sound_hs                         , velocity             )
    , ENTRY( "water"  , "speed of sound"                 , massic_enthalpy , pressure        , IAPWS_R7         , r7::speed_of_sound_hp                         , velocity             )
    , ENTRY( "water"  , "speed of sound"                 , massic_entropy  , massic_enthalpy , IAPWS_R7         , r7::speed_of_sound_sh                         , velocity             )
    , ENTRY( "water"  , "speed of sound"                 , massic_entropy  , pressure        , IAPWS_R7         , r7::speed_of_sound_sp                         , velocity             )
    , ENTRY( "water"  , "speed of sound"                 , pressure        , massic_enthalpy , IAPWS_R7         , r7::speed_of_sound_ph                         , velocity             )
    , ENTRY( "water"  , "speed of sound"                 , pressure        , massic_entropy  , IAPWS_R7         , r7::speed_of_sound_ps                         , velocity             )
    ...
    , ENTRY( "water"  , "temperature"                    , massic enthalpy , massic_entropy  , IAPWS_R7         , r7::temperature_hs                            , temperature          )
    , ENTRY( "water"  , "temperature"                    , massic enthalpy , pressure        , IAPWS_R7         , r7::temperature_hp                            , temperature          )
    , ENTRY( "water"  , "temperature"                    , massic entropy  , massic_enthalpy , IAPWS_R7         , r7::temperature_sh                            , temperature          )
    , ENTRY( "water"  , "temperature"                    , massic entropy  , pressure        , IAPWS_R7         , r7::temperature_sp                            , temperature          )
    , ENTRY( "water"  , "temperature"                    , pressure        , massic_enthalpy , IAPWS_R7         , r7::temperature_ph                            , temperature          )
    , ENTRY( "water"  , "temperature"                    , pressure        , massic_entropy  , IAPWS_R7         , r7::temperature_ps                            , temperature          )
    ...
    , ENTRY( "water"  , "massic_internal_energy"         , pressure        , temperature     , IAPWS_R6_INVERSE , r6_inverse::massic_internal_energy_pt         , massic_energy        )
    , ENTRY( "water"  , "massic_internal_energy"         , temperature     , pressure        , IAPWS_R6_INVERSE , r6_inverse::massic_internal_energy_tp         , massic_energy        )
    , ENTRY( "water"  , "massic_entropy"                 , pressure        , temperature     , IAPWS_R6_INVERSE , r6_inverse::massic_entropy_pt                 , massic_entropy       )
    , ENTRY( "water"  , "massic_entropy"                 , temperature     , pressure        , IAPWS_R6_INVERSE , r6_inverse::massic_entropy_tp                 , massic_entropy       )
    , ENTRY( "water"  , "massic_enthalpy"                , pressure        , temperature     , IAPWS_R6_INVERSE , r6_inverse::massic_enthalpy_pt                , massic_enthalpy      )
    , ENTRY( "water"  , "massic_enthalpy"                , temperature     , pressure        , IAPWS_R6_INVERSE , r6_inverse::massic_enthalpy_tp                , massic_enthalpy      )
    , ENTRY( "water"  , "massic_isochoric_heat_capacity" , pressure        , temperature     , IAPWS_R6_INVERSE , r6_inverse::massic_isochoric_heat_capacity_pt , massic_heat_capacity )
    , ENTRY( "water"  , "massic_isochoric_heat_capacity" , temperature     , pressure        , IAPWS_R6_INVERSE , r6_inverse::massic_isochoric_heat_capacity_tp , massic_heat_capacity )
    , ENTRY( "water"  , "massic_isobaric_heat_capacity"  , pressure        , temperature     , IAPWS_R6_INVERSE , r6_inverse::massic_isobaric_heat_capacity_pt  , massic_heat_capacity )
    , ENTRY( "water"  , "massic_isobaric_heat_capacity"  , temperature     , pressure        , IAPWS_R6_INVERSE , r6_inverse::massic_isobaric_heat_capacity_tp  , massic_heat_capacity )
    , ENTRY( "water"  , "massic_gibbs_free_energy"       , pressure        , temperature     , IAPWS_R6_INVERSE , r6_inverse::massic_gibbs_free_energy_pt       , massic_energy        )
    , ENTRY( "water"  , "massic_gibbs_free_energy"       , temperature     , pressure        , IAPWS_R6_INVERSE , r6_inverse::massic_gibbs_free_energy_tp       , massic_energy        )
    , ENTRY( "water"  , "speed_of_sound"                 , pressure        , temperature     , IAPWS_R6_INVERSE , r6_inverse::speed_of_sound_pt                 , velocity             )
    , ENTRY( "water"  , "speed_of_sound"                 , temperature     , pressure        , IAPWS_R6_INVERSE , r6_inverse::speed_of_sound_tp                 , velocity             )
